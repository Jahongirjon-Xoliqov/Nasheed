...
//            return viewModel.downloadedReciters
//        } else {
//            return viewModel.downloadedReciters.filter {
...
//    var body: some View {
//        NavigationStack {
//            if viewModel.downloadedReciters.isEmpty {
...
struct SavedView: View {
    ...
    var body: some View {
        ReciterListView(
            ...
            reciters: viewModel.downloadedNasheeds 
        )
    }
}
